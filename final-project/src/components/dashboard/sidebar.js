  ...
  >
    ...
    {isOpen && (
            <button
              ...
              className="text-white absolute top-4 right-4 focus:outline-none sm:hidden"
            >
              <svg
                className="w-6 h-6"
                aria-hidden="true"
      ...
      <div className="">
        <Link to="/dashboard/profile" className="flex items-center p-2  rounded-lg text-white  hover:bg-gray-700 group"
           >
      ...
      <ul className="space-y-2 font-medium">
        ...
        <li>
          <button
            ...
            className="flex items-center text-left w-full p-2 rounded-lg text-white  hover:bg-gray-700 group"
          >
            <svg
              className="flex-shrink-0 w-5 h-5  transition duration-75 text-gray-400  group-hover:text-white"
              aria-hidden="true"
